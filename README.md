...
2. Missing template parameter in the API description of Resize function in UG1233. Details [here](https://github.com/Xilinx/xfopencv/tree/master/examples/resize/resize_doc_errata).
